                    ...
                    <?php if (Mistakes::findOne($mistakes['mistake_code'])->quantity == 1 ): ?>
                        <p>
                            ...
                            <?php if ($mistakes['bartaraf_son'] > 0): ?>
                                <b><?php echo "<br> - Шундан " . $mistakes['bartaraf_son'] . " та ҳолатда " . number_format(($mistakes['bartaraf_sum'] / 1000), 1, '.', ' ') . " минг сўмлик камчилик текширув давомида бартараф қилинди ("; ?></b>
