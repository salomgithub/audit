...
$a= ArrayHelper::map(\app\models\data\Orders::find()->all(),'code','code');
$region = \app\models\data\Regions::find()->all();
$branches = \app\models\data\Branches::find()->all();
$region_name = \app\models\data\Regions::findOne(['id'=>$model->region_id])->name;
...
<div class="work-form">
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <?= $form->field($model, 'region_id', ['inputOptions'=>['class' =>'form-control', 'tabindex'=>'1']])->dropDownList($region,[
                'prompt'  => '.......',
                'onchange'=> '
            ...
            <?= $form->field($model, 'branch_id', ['inputOptions'=>['class' =>'form-control', 'tabindex'=>'3']])->dropDownList($branches,
                [
                    'prompt'  => '.......',
                ]); ?>
        ...
        <div class="col-md-3">
            ...
            <?= $form->field($model, 'mistake_code', ['inputOptions'=>['class' =>'form-control', 'tabindex'=>'9']])->dropDownList(ArrayHelper::map(\app\models\data\Mistakes::find()->all(),'code','name' ),
                [
                    'prompt'  => '.......',
                    'onchange'=> '
