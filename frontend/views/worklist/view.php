...
<div class="card">
    <div class="card-body">
        ...
        <ul class="nav nav-tabs d-flex" id="myTabjustified" role="tablist">
            ...
            <?php if ($model->work_status === 0 || $model->work_status === 4): ?>
                <li class="nav-item flex-fill " role="presentation">
                    <button class="nav-link w-100"
                            id="contact-tab"
                            data-bs-toggle="tab" data-bs-target="#contact-justified"
                            type="button" role="tab" aria-controls="contact" aria-selected="false">Бартараф қилиш
                    </button>
                </li>
            <?php endif; ?>
        </ul>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="work-view">
                                        ...
                                        <div class=" mt-3">
                                             <?php if ($xabar !== null && $xabar->xabar !== null) echo "<i>Xabar:".$xabar->xabar."</i>"; ?>
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php
                                                        ...
                                                        if ($work_status == 1)
                                                            echo Html::a('Жараёнда', '#', ['class' => 'btn btn-warning']);;
                                                        if ($work_status == 2)
                                                            echo Html::a('Ёпилган', '#', ['class' => 'btn btn-success']);;
                                                        if ($work_status == 3)
                                                        ...
                                                        <div id="flush-collapseOne" class="accordion-collapse collapse"
                                                            ...
                                                            <div class="accordion-body">
                                                                ...
                                                                <?php if ((file_exists(Yii::getAlias('@webroot') . $pdfPath1)) || (file_exists(Yii::getAlias('@webroot') . $pdfPath2))) : ?>
                                                                    <?php if ($model->work_status === 3) : ?>
                                                                        <object data="/uploads/joyidabartaraf/<?= $model->id ?>.pdf"
                                                                                ...
                                                                                width="100%"></object>
                                                                    <?php endif; ?>
                                                                    <?php if ($model->work_status === 2 || $model->work_status === 1 ) : ?>

                                                                        <object data="/uploads/depbartaraf/<?= $model->id ?>.pdf"
                                                                                type="application/pdf" height="1000px"
                                                                                width="100%"></object>
                                                                    <?php endif; ?>
                                                                ...
                                                                <?php else : ?>
                                                                    ...
                                                                    <br> <p>"ҲужжатAAAA бириктирилмаган?????"</p>
                                                                <?php endif; ?>
                                                                <br>
                                                                <?php if ($model->work_status === 4) : ?>
                                                                    <object data="/uploads/depbartaraf/<?= $model->id ?>.pdf"
                                                                            type="application/pdf" height="1000px"
                                                                            width="100%"></object>
                                                                <?php endif; ?>
                                                                <p>"Ҳужжат бириктирилмаган?????"</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>pdf</td>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="container mt-3">
                                            ...
                                            $form = ActiveForm::begin(['action' => ['bartaraf'],]);
                                            ?>
                                            <div class="row">
                                                <div class="col-md-7">
                                            ...
                                            <div class="row">
                                                <div class="col-md-7">
                                                    <?= $form->field($file, 'commet')->textarea() ?>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-7">
