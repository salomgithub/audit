...
class WorkSearch extends Work
{
    ...
    public function search($params)
    {
        ...
        if(($this->start_data!==null && $this->end_data!==null)  ){
            $query->andFilterWhere(['between', 'create_at', $start, $end]);
        }
...
//            ->andFilterWhere(['between', 'create_at', $start, $end])
    ...
    public function bartaraf($params)
    {
        $query = Work::find();

        if (!Yii::$app->user->isGuest) {
            $user_id = Yii::$app->user->id;
            $dep_id = User::findOne($user_id)->dep_id;
