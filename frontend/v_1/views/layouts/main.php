...
<?php $this->beginPage() ?>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link <?= in_array(Yii::$app->controller->id, ['dashboard', 'work', 'worklist', 'permission']) ? '' : 'collapsed' ?>"
                   data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-menu-button-wide"></i><span>Audit Tekshiruvi natijalari</span><i
                            class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="components-nav"
                    class="nav-content collapse <?= in_array(Yii::$app->controller->id, ['dashboard', 'work', 'worklist', 'permission']) ? 'show' : '' ?>"
            ...
            <li class="nav-item">
                <a class="nav-link  <?= in_array(Yii::$app->controller->id, ['davomat', 'kunlik','orders']) ? '' : 'collapsed' ?> "
                   data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-layout-text-window-reverse"></i><span>Hisobotlar</span><i
                            class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="tables-nav"
                    class="nav-content collapse <?= in_array(Yii::$app->controller->id, ['davomat', 'kunlik', 'orders',]) ? 'show' : '' ?>"
                    data-bs-parent="#sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link <?= in_array(Yii::$app->controller->id, ['user', 'role', 'assignment', 'permission', 'route', 'rule', 'menu']) ? '' : 'collapsed' ?>"
                   data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-journal-text"></i><span>Foydalanuvchilar</span><i
                            class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="forms-nav"
                    class="nav-content collapse <?= in_array(Yii::$app->controller->id, ['user', 'role', 'assignment', 'permission', 'route', 'rule', 'menu']) ? 'show' : '' ?>"
                    data-bs-parent="#sidebar-nav">
            ...
            <li class="nav-item ">
                <a class="nav-link <?= in_array(Yii::$app->controller->id, [ 'departaments', 'branches', 'mistakes']) ? '' : 'collapsed' ?>"
                   data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-bar-chart"></i><span>Monitoring</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="charts-nav" class="nav-content collapse <?= in_array(Yii::$app->controller->id, ['departaments', 'branches', 'mistakes']) ? 'show' : '' ?> " data-bs-parent="#sidebar-nav">
